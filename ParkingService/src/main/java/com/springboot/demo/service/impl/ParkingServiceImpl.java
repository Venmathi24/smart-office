...
public class ParkingServiceImpl implements ParkingService{
    ...
    @Override
    public List<ParkingSlots> getSlotsByOccupationStatus(String isOccupied) {
    ...
    public ParkingSlots updateSlot(Long id, ParkingSlots updatedSlot) {
        ...
        slot.setIsOccupied(updatedSlot.getIsOccupied());
        slot.setOccupiedByEmployeeCode(updatedSlot.getOccupiedByEmployeeCode());
        slot.setOccupiedByEmployeeName(updatedSlot.getOccupiedByEmployeeName());
